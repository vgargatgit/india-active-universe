...
To inspect pre-2013 candidate readiness without changing data, use `india-equity-data candidate-readiness --release-id <release>`. For the 2006 candidate specifically, use `india-equity-data candidate-readiness --release-id <release> --candidate-start 2006-01-01`; this reports candidate gate-pass readiness, the date's research-quality status, and strict research-ready status separately.
