...
def main() -> None:
    ...
    parser.add_argument("--coverage-end", default="2026-08-10")
    ...
    print(json.dumps({"unknown_terminal_events": len(rows), "coverage_end": args.coverage_end}, sort_keys=True))
