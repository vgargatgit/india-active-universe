# Release completion audit: `india_equity_data_v2.2.3`
...
- Corporate-action boundary validation: `{"NO_LOCAL_BOUNDARY_OBSERVATION": 42, "NO_POST_EVENT_OBSERVATION": 75, "NO_PRE_EVENT_OBSERVATION": 73, "PASS": 1026, "WARNING_LARGE_BOUNDARY_MOVE": 63}`.
- Unresolved required material price-action boundaries: 77.
...
- Test results: `{"early_model_arena_handoff_passed": true, "errors": 0, "failures": 0, "model_arena_handoff_passed": true, "multi_era_source_fixture_passed": true, "skipped": 0, "tests": 105}`.
- GitHub Actions CI: `{"conclusion": "success", "descends_from_release_git_commit": true, "failed_jobs": [], "head_sha": "b34d58afbb135d22814a1a5c1c8f61e22c204f5e", "job_count": 1, "matches_release_git_commit": true, "release_git_commit": "b34d58afbb135d22814a1a5c1c8f61e22c204f5e", "run_id": 31520684118, "run_url": "https://github.com/vgargatgit/india-active-universe/actions/runs/31520684118", "status": "completed", "workflow_name": "ci"}`.
...
- The complete 2006 onward archive is exploratory unless covered by a manifest research-quality interval; the scoped `2012-08-31` onward research universe is RESEARCH_HIGH_CONFIDENCE.
