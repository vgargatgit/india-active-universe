# Release completion audit: `india_equity_data_v2.1.0`
...
- FAIL: research manifest material_price_action_unresolved_boundaries is not zero
- FAIL: research manifest test_result_sha256 is missing or invalid
- FAIL: missing research report `test_results_india_equity_data_v2.1.0.xml`
