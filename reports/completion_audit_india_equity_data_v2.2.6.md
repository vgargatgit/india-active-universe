# Release completion audit: `india_equity_data_v2.2.6`
...
- Corporate-action boundary validation: `{"ADVISORY_BOUNDARY_DRIFT": 31, "NO_LOCAL_BOUNDARY_OBSERVATION": 42, "NO_POST_EVENT_OBSERVATION": 75, "NO_PRE_EVENT_OBSERVATION": 73, "PASS": 1054, "WARNING_LARGE_BOUNDARY_MOVE": 3}`.
- Unresolved required material price-action boundaries: 28.
...
- Test results: `{"early_model_arena_handoff_passed": true, "errors": 0, "failures": 0, "model_arena_handoff_passed": true, "multi_era_source_fixture_passed": true, "skipped": 0, "tests": 108}`.
- GitHub Actions CI: `{"conclusion": "success", "descends_from_release_git_commit": true, "failed_jobs": [], "head_sha": "d8188139495f0f9a7bf5b150ba783b4e339c2903", "job_count": 1, "matches_release_git_commit": true, "release_git_commit": "d8188139495f0f9a7bf5b150ba783b4e339c2903", "run_id": 31525703004, "run_url": "https://github.com/vgargatgit/india-active-universe/actions/runs/31525703004", "status": "completed", "workflow_name": "ci"}`.
...
- The complete 2006 onward archive is exploratory unless covered by a manifest research-quality interval; the scoped `2011-08-30` onward research universe is RESEARCH_HIGH_CONFIDENCE.
