...
| 2009-01-01 | `FAIL` | `PASS` | `PASS` | `PASS` | `PASS` | `REVIEW_REQUIRED` | `PASS` | `PASS` | `contaminating_signal_window_non_pass_boundaries=6, price_action.contaminating_signal_window_non_pass_boundaries=6` | `NOT_READY` |
| 2007-01-01 | `FAIL` | `PASS` | `PASS` | `PASS` | `PASS` | `FAIL_MISSING_FACTORS` | `PASS` | `PASS` | `contaminating_signal_window_non_pass_boundaries=8, material_missing_factors=1, price_action.contaminating_signal_window_non_pass_boundaries=8, price_action.material_missing_factors=1` | `NOT_READY` |
| 2006-01-01 | `FAIL` | `PASS` | `PASS` | `PASS` | `PASS` | `FAIL_MISSING_FACTORS` | `PASS` | `PASS` | `contaminating_signal_window_non_pass_boundaries=8, material_missing_factors=1, price_action.contaminating_signal_window_non_pass_boundaries=8, price_action.material_missing_factors=1` | `NOT_READY` |
