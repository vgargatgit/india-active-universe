...
| Signal warmup | `31590` pre-2013 monthly rows are not ready for 273-session momentum-style history. | Universe eligibility is separate from model/signal readiness. |
...
| Early monthly artifact coverage | `99375` rows, `3394` securities, `2505` required-scope securities before `2013-01-01`. | Zero values mean early candidate snapshots have not yet been materialized into this release. |
